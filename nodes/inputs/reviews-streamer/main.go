...
import (
	...
	"github.com/LaCumbancha/reviews-analysis/nodes/inputs/reviews-streamer/common"
...
func InitConfig() (*viper.Viper, *viper.Viper, error) {
	...
	configEnv.BindEnv("streamer", "clients")
...
func main() {
	...
	streamerClients := utils.GetConfigInt(configEnv, configFile, "streamer_clients")
	
	if streamerClients == 0 {
		log.Fatalf("StreamerClients variable missing")
	}
	...
	streamerConfig := common.StreamerConfig {
		Instance:				instance,
		RabbitIp:				rabbitIp,
		RabbitPort:				rabbitPort,
		StreamerClients:		streamerClients,
	...
	streamer := common.NewStreamer(streamerConfig)
