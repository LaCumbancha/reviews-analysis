...
func InitConfig() (*viper.Viper, *viper.Viper, error) {
	...
	configEnv.BindEnv("userhash", "aggregators")
...
func main() {
	...
	userhashAggregators := utils.GetConfigInt(configEnv, configFile, "userhash_aggregators")
	
	if userhashAggregators == 0 {
		log.Fatalf("UserhashAggregators variable missing")
	}
	...
	aggregatorConfig := common.AggregatorConfig {
		...
		UserhashAggregators:	userhashAggregators,
	}
