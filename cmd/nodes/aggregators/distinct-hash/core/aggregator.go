...
func NewAggregator(config AggregatorConfig) *Aggregator {
	...
	inputDirect := rabbitmq.NewRabbitInputDirect(props.HashAggregatorOutput, config.InputTopic, ch)
	outputQueue := rabbitmq.NewRabbitOutputQueue(props.DishashAggregatorOutput, config.Instance, config.DishashFilters, ch)
