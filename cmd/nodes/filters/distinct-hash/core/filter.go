...
func NewFilter(config FilterConfig) *Filter {
	...
	inputQueue := rabbitmq.NewRabbitInputQueue(props.DishashAggregatorOutput, ch)
	outputDirect := rabbitmq.NewRabbitOutputDirect(props.DishashFilterOutput, config.Instance, config.DishashJoiners, ch)
	filter := &Filter {
		connection:		conn,
		channel:		ch,
