...
import (
	...
	"github.com/LaCumbancha/reviews-analysis/cmd/nodes/filters/bot-users/rabbitmq"
...
func NewFilter(config FilterConfig) *Filter {
	...
	inputQueue := rabbitmq.NewRabbitInputQueue(props.BotUsersAggregatorOutput, ch)
	outputDirect := rabbitmq.NewRabbitOutputDirect(props.BotUsersFilterOutput, config.Instance, config.DishashJoiners, ch)
	filter := &Filter {
		connection:		conn,
		channel:		ch,
